var DataService = function () { // DataService is like the DAO - CRUD BASICALLY Anytime u interact with the API 
  var self = this; // Here we are setting the function definition to the variable self
​
