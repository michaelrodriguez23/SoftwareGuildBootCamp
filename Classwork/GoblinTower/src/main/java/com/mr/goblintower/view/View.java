 ...
 */
package com.mr.goblintower.view;
...
public class View {
    ...
    public void printGameOver(Hero myHero){
        this.print("You have Died!");
        this.print("You've reached floor " + myHero.getLevel());
        this.print("You've taken " + myHero.getSteps() + "steps");
    }
}
